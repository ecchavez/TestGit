...
<body topmargin="0">
<% 
	System.out.println("Pagina 403.jsp ejecutada"); 
    ...
    <td height="400" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><p>&nbsp;</p>
                        <p class="textorojo"><strong>Prohibido</strong></p><br>
                        <p> El servidor ha podido ser contactado, y ha recibido una petici&oacute;n v&aacute;lida, pero ha denegado el acceso a la acci&oacute;n que se solicita.<br>
                      Disculpe las molestias.</p>
                        <p>
                      Con frecuencia es debido a peticiones por rutas que correspondan a directorios del sistema de   ficheros, para los cuales se hayan deshabilitado la opci&oacute;n de listar sus contenidos.<br><br>
                      Usted puede:</p>
