...
<body topmargin="0">
<% 
	System.out.println("Pagina 404.jsp ejecutada"); 
    ...
    <td height="400" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><p>&nbsp;</p>
                        <p class="textorojo"><strong>P&aacute;gina no encontrada</strong></p><br>
                        <p> La p&aacute;gina solicitada puede no estar disponible, haber cambiado de direcci&#243;n (URL) o no existir.<br>
                      Disculpe las molestias.</p>
                        <p>
                      Con frecuencia es debido a algun error al escribir la p&aacute;gina (URL).Compruebela de nuevo para ver si es correcta. <br><br>
                      Usted puede:</p>
