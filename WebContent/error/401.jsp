...
<body topmargin="0">
<% 
	System.out.println("Pagina 401.jsp ejecutada"); 
    ...
    <td height="400" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><p>&nbsp;</p>
                        <p class="textorojo"><strong>
No autorizado</strong></p><br>
                        <p>El acceso al recurso URL requiere autenticaci&oacute;n,  pero no super&oacute; las pruebas de autorizaci&oacute;n.<br>
                      Disculpe las molestias.</p>
                        <p>Generalmente, este mensaje de error significa que usted tiene primero que iniciar sesi&oacute;n o el usuario y/o contrase&#241;a son inv&aacute;lidos.<br><br>
                      Usted puede:</p>
