          ...
          <tr>
            <td width="100%" height="31"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="75" id="TituloModulo"><div id="lbl_user_sesion"><%= "usr"%></div></td>
                <td width="73">&nbsp;</td>
                </tr>
            </table></td>
            </tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <c:if test="${responseDatosDigit.respDatosUploadDigitFile.mensaje eq 'FAULT'}">
					  		...
					  		window.location='<%=basePath %>/UploadMultipleFileDocuments.htm?paramMensaje=<c:out value="${responseDatosDigit.respDatosUploadDigitFile.descripcion}"/>';
					  		</script>
					  	</c:if> 
