		...
		<form action="" id="paramSeleccionCarCli">
			...
			<table width="335" border="0" align="center" cellpadding="0" cellspacing="0">
			    ...
			    <tr>
			      ...
			      <td><input type="text" style="text-transform: uppercase;" id="nomTxt"  onkeyup="this.value=this.value.toUpperCase();" class="k-textbox" onkeypress="return captureNombres(event)"/>
			      </td>
			      <td>
			    ...
			    <tr>
			      <td><input  type="button" class="k-button" id="aceptarCriterios" value="Aceptar" onclick="buscarClientesSAP()"/></td>
			      <td><input  type="button" class="k-button" id="cancelarCriterios" value="Cancelar" onclick="cancelarSelecSap()"/></td>
			      <td>&nbsp;</td>
			    </tr>
			    <tr>
			      <td height="26">&nbsp;</td>
