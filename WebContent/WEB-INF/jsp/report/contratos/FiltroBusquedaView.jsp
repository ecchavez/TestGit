...
<title>Contratos</title>
    ...
    $(document).ready(function() {
		...
		function verReporte () {
			document.getElementById('visorReporte').src="<%= request.getContextPath()%>/report/contratos/GeneraReporteContratos.htm?idEstatusReporte=" + $('#estatusP').val() + "&idFaseReporte=" + $('#faseReporteP').val() + "&idEquipoInicialReporte=" + $('#equipoReporteP').val() + "&idEquipoFinalReporte=" + $('#equipoReportefinP').val() ;			
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="424" id="TituloModulo">Reporte contratos</td>
