...
<title>ListaPrecios</title>
    ...
    $(document).ready(function() {
		...
		function verReporte () {
			document.getElementById('visorReporte').src="<%= request.getContextPath()%>/report/listaprecios/GeneraReporteListaPrecios.htm?idTipoReporte=" + $('#tipoP').val() + "&idFaseReporte=" + $('#faseReporteP').val() + "&idEquipoInicialReporte=" + $('#equipoReporteP').val() + "&idEquipoFinalReporte=" + $('#equipoReportefinP').val() ;			
			setEstatusBar("Generando reporte","mensaje");
		}
		
		function verReporteExcel () {
			document.getElementById('visorReporte').src="<%= request.getContextPath()%>/report/listaprecios/GeneraReporteListaPreciosExcel.htm?idTipoReporte=" + $('#tipoP').val() + "&idFaseReporte=" + $('#faseReporteP').val() + "&idEquipoInicialReporte=" + $('#equipoReporteP').val() + "&idEquipoFinalReporte=" + $('#equipoReportefinP').val() ;			
			setEstatusBar("Generando reporte","mensaje");
		}
</script>
        ...
        <td width="100%" background="<%=basePath %>/images/images/pages/header_middle.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="424" id="TituloModulo">Reporte lista de precios</td>
          ...
          <tr>
            <td height="32"><table width="95%" height="16" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="65" align="left"><a class="k-button" id="seleccionCarCli" onclick="dialogoFiltroConsultaEdoCtaReporte()">Seleccionar</a></td>
                <td width="68" align="left"><a class="k-button" id="verDetalleReporte" style="visibility: hidden;" onclick="verReporte()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PDF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
                <td width="65" align="left"><a class="k-button" id="verDetalleReporteExcel" style="visibility: hidden;" onclick="verReporteExcel()">Descarga</a></td>
                <td width="118">&nbsp;</td>
                <td width="118">&nbsp;</td>
                <td width="118">&nbsp;</td>
                <td width="118">&nbsp;</td>
