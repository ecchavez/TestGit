...
<title>Estado de Cuenta</title>
    ...
    $(document).ready(function() {
		...
		function verReporte () {
			var grid = window.parent.$("#GridConsultaCatalogoReportes").data("kendoGrid");
		    ...
		    if (model == undefined ) {
		    	...
		    	document.getElementById('visorReporte').src="<%= request.getContextPath()%>/report/estadocuenta/GeneraReporte.htm?idClienteReporte=" + model.idCliente + "&idPedidoReporte=" + model.pedido;
			}
			
			//window.frames["visorReporte"].src ="<%= request.getContextPath() %>/report/estadocuenta/GeneraReporte.htm";
			//window.frames["visorReporte"].document.forms[0].submit();
			//document.getElementById("visorReporte").document.visorReporteForm.submit();
			//document.getElementById("visorReporte").src="<%= request.getContextPath() %>/report/estadocuenta/GeneraReporte.htm";
		}
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="424" id="TituloModulo">Reporte estado de cuenta</td>
          ...
          <tr>
            <td height="32"><table width="95%" height="16" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="68"><a class="k-button" id="verDetalleReporte" style="visibility: hidden;" onclick="verReporte()">Reporte</a></td>
                <td width="65">&nbsp;</td>
                <td width="118">&nbsp;</td>
                <td width="118">&nbsp;</td>
                <td width="118">&nbsp;</td>
