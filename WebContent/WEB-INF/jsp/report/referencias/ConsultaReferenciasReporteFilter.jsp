...
%>		<script src="<%=basePath %>/js/jquery-1.7.2.js"></script>
		...
		<script>
         ...
         $(document).ready(function () {
			...
			$("#bancoReporte").kendoComboBox({
				dataTextField: "banka",
				dataValueField: "bankl",
				dataSource: [],
				filter: "contains",
				//change: onChangeBancoReporte,
				suggest: true
		    });	 


			fillComboRegistroReporte("faces");
			fillComboRegistroReporte("banco");
		    
         });

         function getConsultaFiltroRefRep()
         {
        	 window.parent.executeFindBusquedaCatalogoReporteFilter($("#bancoReporte").val(),$("#faseReporte").val(),$("#equipoReporte").val(),$("#equipoReportefin").val());
         }
	...
	<body>
		...
		<table align="center">
			...
			<tr>
				<td>
					<fieldset>
						<legend><b> B&uacute;squeda por banco </b></legend>
						<table width="306" border="0" align="left">
							<tr>
								<td nowrap="nowrap">Banco</td>
								<td nowrap="nowrap">
									<select id="bancoReporte" name="bancoReporte" style="width: 5cm;">
									</select>
								</td>
								<td nowrap="nowrap">
									<div id="descripcionBanco"></div>&nbsp;
								</td>
							</tr>
						</table>
					</fieldset>
			...
			<tr>
				<td align="left">
					<input type="button" class="k-button" id="aceptarParam" value="Aceptar" onclick="getConsultaFiltroRefRep()"/>&nbsp;
