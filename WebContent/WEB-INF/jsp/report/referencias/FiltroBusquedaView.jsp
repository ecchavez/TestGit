...
<title>Referencias</title>
    ...
    <script type="text/javascript">
     ...
     <script src="<%=basePath %>/js/reportes/referencias/Referencias.js"></script>
    ...
    $(document).ready(function() {
		...
		function verReporte () {
			document.getElementById('visorReporte').src="<%= request.getContextPath()%>/report/referencias/GeneraReporteReferencias.htm?idFaseLow=" + $('#idFaseLowP').val() + "&idBancoLow=" + $('#idBancoLowP').val() + "&idEquipoInicialReporte=" + $('#equipoReporteP').val() + "&idEquipoFinalReporte=" + $('#equipoReportefinP').val() ;			
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="424" id="TituloModulo">Reporte referencias</td>
...
<input type="hidden" id="idFaseLowP" name="idFaseLowP" value="" />
<input type="hidden" id="idFaseHighP" name="idFaseHighP" value="" />
<input type="hidden" id="idBancoLowP" name="idBancoLowP" value="" />
<input type="hidden" id="idBancoHighP" name="idBancoHighP" value="" />
