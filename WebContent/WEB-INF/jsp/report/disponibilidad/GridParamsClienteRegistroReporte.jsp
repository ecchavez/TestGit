			...
			<table width="343" height="186" border="0" align="center">
										<tr>
											<td width="152">
												Nombre</td>
											<td width="154">
												<input type="text" id="nomTxt"  class="k-textbox" onkeypress="return captureNombres(event)"/>
											</td>
										</tr>
										<tr>
											<td>
												Segundo Nombre</td>
											<td>
												<input type="text" id="nom2Txt" class="k-textbox" onkeypress="return captureNombres(event)" />
											</td>
										</tr>
										<tr>
											<td>
											...
											<td><input type="text" id="apPatTxt" class="k-textbox" onkeypress="return captureNombres(event)" /></td>
										</tr>
										<tr>
											<td>
												Apellido Materno</td>
											<td>
												<input type="text" id="apMatTxt" class="k-textbox" onkeypress="return captureNombres(event)" />
											</td>
										</tr>
										<tr>
											<td>
