...
%>
		...
		<script>
			$(document).ready(function () {
				var dataSourceGridClienteTicket = new kendo.data.DataSource({
			        data: [],	    	    	        
			        pageSize: 50,
			        messages: {
				...
				$("#gridclientesTicket").kendoGrid( {
					 dataSource : dataSourceGridClienteTicket,
					 selectable:"row",
					 resizable: true,							
					 sortable: true,
					 reorderable: true,	
	...
	<body>
		<form action="" id="GridBusquedaClienteTicketForm">
		<table width="306" border="0" cellpadding="1" cellspacing="1" align="left">
			<tr align="center">
                <td colspan="2" align="left"><a class="k-button" id="seleccionCarCli" onclick="dialogoParamsClienteRegistroTicket()">Seleccionar</a></td>
			</tr>		
			<tr align="center">
				<td colspan="2" align="left">
					<div id="gridClienteTicketWrapper">					
						<div id="gridclientesTicket" style="height: 330px; width:650px"></div>
					</div> 
				</td>
			</tr>
			<tr>
		...
		<div id="windowParamsBusquedaClienteRegistroTicket"></div>
		</form>
	</body>
</html>