...
<title>Registro Tickets</title>
    ...
    $(document).ready(function() {
		...
		if($("#txtArea").text() == 'ADMINISTRACIÓN'){
			$("#fechat").val('');
			$("#asignado").val('');
			$(".ocultar").hide();
			$("#observaciones").val('');
        ...
        <form id="atencionTicketForm" name="atencionTicketForm" action="<%=basePath%>/ticket/UpdateTicketConstruccion.htm" method="post">
          <table border="0">
            <tbody>
              ...
              <tr valign="top" class="ocultar">
                <td align="right" valign="middle">Atiende:</td>
                <td><input type="text" id="asignado" onblur="javascript:this.value=this.value.toUpperCase().trim();"  name="asignado" class="k-textbox" style="width: 5cm; text-transform: uppercase" size="50" maxlength="40" onKeyPress="return letrasnumeros(event)"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr valign="top" class="ocultar">
                <td align="right" valign="middle">Fecha de atenci&oacute;n:</td>
              ...
              <tr valign="top">
                <td colspan="6"><input type="button" class="k-button" onclick="atencionTicketConstruccion()" value="Aceptar"/>
                  &nbsp;<input type="button" class="k-button" onclick="cancelAtencionVicio()" value="Cancelar"/></td>
              </tr>
            </tbody>
          </table>
          ...
          <input type="hidden" id="estatusHidden" name="estatus" value="APROBAR">
