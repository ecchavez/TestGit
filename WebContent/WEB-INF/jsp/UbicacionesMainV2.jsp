        ...
        <td width="100%" background="<%=basePath %>/images/images/pages/header_middle.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="31"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="155" height="25" id="TituloMain">Gestion de Vivienda: </td>
                ...
                <td width="73"align="center"><input type="image" name="imageField8" id="imageField8" src="<%=basePath %>/images/exitr32.png" alt="SALIR" onclick="salirSistema()"></td>
                </tr>
            </table></td>
            </tr>
          <tr>
          ...
          <tr>
            <td height="32"><table width="95%" height="16" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="65"><input type="button" id="btn_open_cotizador" value="Cotizar" onclick="if(validaIngresoModulos('CTR_UBIC', 'PERMISO_C')){setImageToLeft('left',datosEqDet[0].id_equnr)}else{$('#mensajes_main').html('Sin permisos para este modulo')}" class="k-button"/></td>
