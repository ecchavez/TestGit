 ...
 * Fecha de creación: XX/06/2012               
 */
public class ResponseTicketConstruccionDto {
	private String mensaje;
	private String descripcion;
	private String id_ticket_z;
	private String id_ticket_sap;

	private List<TicketHeaderDto> listTicket;
	...
	public List<TicketHeaderDto> getListTicket() {
		return listTicket;
	}
	public void setListTicket(List<TicketHeaderDto> listTicket) {
