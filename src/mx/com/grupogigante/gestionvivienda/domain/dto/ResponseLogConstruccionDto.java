 ...
 * Fecha de creación: XX/06/2012               
 */
public class ResponseLogConstruccionDto {
	private String mensaje;
	private String descripcion;
	private String id_ticket_z;
	private String id_ticket_sap;

	private List<TicketLogDto> listTicket;
	...
	public List<TicketLogDto> getListTicket() {
		return listTicket;
	}
	public void setListTicket(List<TicketLogDto> listTicket) {
